...
var app = function app() {
  ...
  ObjC.registerSubclass({
    ...
    methods: {
      'click': {
        types: ['void', ['id']],
        implementation: function implementation(sender) {
          ...
          if (panel.runModal == $.NSOKButton) {
            ...
            var imgView = $.NSImageView.alloc.initWithFrame($.NSMakeRect(0, mainWindow.height(), img.size.width, img.size.height));

            mainWindow.resize(img.size.width > minWidth ? img.size.width : minWidth, (img.size.height > minHeight ? img.size.height : minHeight) + ctrlsHeight);

            imgView.setImage(img);
            mainWindow.el.displayIfNeeded();
...
},{"./stardust":3,"underscore":2}],2:[function(require,module,exports){
//     Underscore.js 1.8.3
...
stardust.button = function (settings) {
  ...
  var button = $.NSButton.alloc.initWithFrame(stardust.makeRect.apply(stardust, _toConsumableArray(opts.rect)));
...
stardust.textField = function (settings) {
  ...
  var field = $.NSTextField.alloc.initWithFrame(stardust.makeRect.apply(stardust, _toConsumableArray(opts.rect)));
...
stardust.fieldLabel = function (settings) {
  ...
  var label = $.NSTextField.alloc.initWithFrame(stardust.makeRect.apply(stardust, _toConsumableArray(opts.rect)));

...
stardust.button = function(settings) {
  ...
  obj.el = $.NSButton.alloc.initWithFrame(stardust.makeRect(...opts.rect));
  obj.classString = $.NSStringFromClass(obj.el.class).js;
...
stardust.textField = function(settings) {
  ...
  obj.el = $.NSTextField.alloc.initWithFrame(stardust.makeRect(...opts.rect));
  obj.classString = $.NSStringFromClass(obj.el.class).js;
...
stardust.image = function(settings) {
  ...
  obj.el = $.NSImageView.alloc.initWithFrame(stardust.makeRect(...obj.rect));
  obj.classString = $.NSStringFromClass(obj.el.class).js;
